...
tags: ["mini-pcs", "htpc", "hardware", "budget"]
layout: article.njk
---
...
<figure>
  <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800&h=400&fit=crop" alt="Computer hardware setup" loading="lazy">
  <figcaption>Mini PC setup for home theater</figcaption>
</figure>
...
4. Disable sleep: Settings → System → Power → Screen and sleep → Never
...
Play this test file in Kodi: [Dolby test files](https://www.dolby.com/technologies/dolby-atmos/demo-trailers/)
...
| Play/Pause | Space |
| Stop | X |
| Skip forward | Page Down or → (held) |
| Skip backward | Page Up or ← (held) |
| Volume up | + or = |
| Volume down | - |
| Mute | F8 |
...
<figure>
  <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800&h=400&fit=crop" alt="Budget HTPC setup" loading="lazy">
  <figcaption>Complete budget HTPC build</figcaption>
</figure>
...
4. Check Kodi display calibration (Settings → System → Display)
...
- Clean Kodi library monthly: Settings → Media → Library → Clean library
- Monitor storage usage

**LibreELEC systems:**
- Updates install automatically
- Minimal maintenance required
- Backup settings periodically: Settings → System → Backup
...
<div class="cta-box">
  <h3>Start Your Budget HTPC Build Today</h3>
  <p>With mini PC prices at all-time lows, there's never been a better time to build a home theater PC. Start with the Beelink EQ12 for the simplest experience, or the S12 Pro if you want server capabilities.</p>
  <a href="https://www.amazon.com/s?k=beelink+mini+pc" target="_blank" rel="noopener" class="btn btn-primary">Shop Budget Mini PCs on Amazon</a>
</div>
